...
\label{Results:bye5}
\end{table}
The use of a window size of 50 ms guarantees the best trade-off between the number of audio peaks and the correct detection of all the audio peaks related to the keyboard events.\\
