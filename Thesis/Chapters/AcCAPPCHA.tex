...
\cline{1-1}
\texttt{\key{<!DOCTYPE html>}}&\hspace{0.5cm}\multirow{7}{*}{\includegraphics[scale=0.8]{Images/AcCAPPCHA/no_db_html}}\\
\texttt{\key{<html>}}&\\
...
\begin{tabular}{|p{6cm}|c}
\cline{1-1}
\texttt{\key{<!DOCTYPE html>}}&\hspace{0.5cm}\multirow{7}{*}{\includegraphics[scale=0.8]{Images/AcCAPPCHA/failure_html}}\\
\texttt{\key{<html>}}&\\
\texttt{\hspace{0.5cm}\key{<body>}}&\\
\texttt{\hspace{1.0cm}\key{<h1>}Failure\key{</h1>}}&\\
...
\begin{tabular}{|p{6cm}|c}
\cline{1-1}
\texttt{\key{<!DOCTYPE html>}}&\hspace{0.5cm}\multirow{7}{*}{\includegraphics[scale=0.8]{Images/AcCAPPCHA/logged_html}}\\
\texttt{\key{<html>}}&\\
\texttt{\hspace{0.5cm}\key{<body>}}&\\
