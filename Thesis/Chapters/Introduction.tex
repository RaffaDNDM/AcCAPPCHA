...
In \myref{Chapter}{chapter:SideCH} Side Channel attacks are described in details.\\
In \myref{Chapter}{chapter:InvisibleCAPPCHA} Invisible CAPPCHA is described in details.\\
In \myref{Chapter}{chapter:AcCAPPCHA} AcCAPPCHA is described in details.\\In \myref{Chapter}{chapter:Results} Results are described in details.\\
In \myref{Chapter}{chapter:Future} Future work is described in details.\\
In \myref{Appendix}{appendix:KeyMapping} AcCAPPCHA is described in details.\\
In \myref{Appendix}{appendix:Program} Program is described in details.\\